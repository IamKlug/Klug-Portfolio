      ...
      <nav className="navbar navbar-item has-background-primary" role="navigation" aria-label="main navigation">
        ...
        <div className='is-flex is-flex-direction-column is-justify-content-center is-align-items-center mb-6'>
          ...
          <figure className='image is-3by5'>  
            <img className='is-rounded' src='/assets/tiny-head-shot.png' />
            ...
            <div className='columns'>
              <div className='column has-text-centered'>
                ...
                <div className='is-relative'>
                    ...
                    <figure className='image'>
                      <a href='https://klug-task-management-git-master-iamklug.vercel.app/'><img className='' src='/assets/tiny-kanban-image.png' /></a>
                    </figure>
                  </div>
                </div>
              </div>
              <div className='column has-text-centered'>
                ...
                <span className='tag is-link is-medium'>This one too! This one's a treat!</span>
                    <figure className='image'>
                      <a href='https://multi-step-form-vercel-iamklug.vercel.app/'><img className='' src='assets/tiny-form-image.png' /></a>
                    </figure>
                  </div>
                </div>
              </div>
